        ...
        <CardContent className="flex items-center gap-6">
          <div className="relative group">
            {avatarUrl ? (
              ...
              <div className="h-20 w-20 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-2xl font-medium">
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSave} className="space-y-4" autoComplete="off">
            ...
            <div className="grid gap-2">
              <Label htmlFor="golfClub">Golf</Label>
              <Input
                id="golfClub"
                value={golfClub}
                onChange={(e) => setGolfClub(e.target.value)}
                placeholder="Votre club de golf"
              />
            </div>
